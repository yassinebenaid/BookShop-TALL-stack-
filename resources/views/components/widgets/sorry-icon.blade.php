<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <path class="fill-neutral-300"
        d="M45.4,47.9c-0.9,0-1.7-0.6-1.9-1.5c-0.1-0.3-2.3-8.4-11.8-8.4h-0.5c-9.6,0-11.7,8-11.8,8.4
    ...
    <circle class="fill-neutral-300" cx="20.7" cy="25.3" r="3.5" />
    <circle class="fill-neutral-300" cx="41.4" cy="25.3" r="3.5" />
</svg>
